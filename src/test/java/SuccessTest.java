...
public class SuccessTest {
    ...
    public void checkCreateOrder(){
        ...
        var pathCreateProduct = "/createProduct?name=" + productName +"&price=" + productPrice;
        ...
        TestUtils.callDelete(pathDeleteOrder).assertThat().statusCode(200);

        var pathDeleteProduct = "/deleteProductById?id=" + idProduct;
        TestUtils.callDelete(pathDeleteProduct).assertThat().statusCode(200);

        var pathDeleteUser = "/deleteUserById?id=" + idUser;
        TestUtils.callDelete(pathDeleteUser).assertThat().statusCode(200);
